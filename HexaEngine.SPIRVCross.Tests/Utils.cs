namespace HexaEngine.SPIRVCross.Tests
{
    ...
    {
        public static void CheckResult(this SpvcResult result)
        {
            if (result != SpvcResult.Success)
                throw new(result.ToString());
        }

        public static void CheckResult(this SpvcResult result, SpvcContext context)
        {
            if (result != SpvcResult.Success)
                throw new(SPIRV.SpvcContextGetLastErrorStringS(context));
        }
