namespace Hexa.NET.SPIRVCross.Tests
{
    ...
    public class SPIRVException : Exception
    {
        public SPIRVException(string message) : base(message)
        {
        }
    }
    ...
    {
        public static void CheckResult(this SpvcResult result, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0, [CallerMemberName] string member = "")
        {
